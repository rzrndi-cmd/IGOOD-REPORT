 ...
 */
    ...
    function verifyAdminAuth() {
        ...
        if (selectedEmp.role === 'Super Admin') {
            isValid = (password === 'igoodrame' || password === ADMIN_PASSCODE);
        } else if (selectedEmp.role === 'Admin') {
            isValid = (password === 'ramebanget' || password === 'igoodrame' || password === ADMIN_PASSCODE);
        } else {
            isValid = (password === ADMIN_PASSCODE || password === 'igoodrame' || password === 'ramebanget');
        }
    ...
    function bindNavigation() {
        ...
        $('btnVerifySuperAdminAuth')?.addEventListener('click', () => {
            const input = $('superAdminPasswordInput');
            const err = $('superAdminAuthError');
            if (input?.value === 'igoodrame') {
                $('superAdminAuthModal')?.classList.remove('open');
    ...
    function init() {
        ...
        $('dailyReportShift')?.addEventListener('change', renderDailyReport);
